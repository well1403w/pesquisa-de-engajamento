  ...
  steps: [
    {
      ...
      type: "radio",
      options: ["Menos de 1 ano", "1 a 5 anos", "6 a 10 anos", "11 a 15 anos", "16 a 20 anos", "21 anos e acima"
      ]
    },
    {
      number: 2,
      ...
      type: "radio",
      options: ["18 a 25 anos", "26 a 45 anos", "46 a 60 anos", "A partir de 61 anos"]
    },
    {
      number: 3,
      question: "3. Qual gênero se reconhece?",
      type: "radio",
      options: ["Masculino", "Feminino", "Não Binário", "Transgênero", "Prefiro não Declarar"]
    },
    {
      number: 4,
    ...
    {
      number: 7,
      question: "7.Na Masterboi as pessoas são bem tratadas, independentemente da religião; cultura; cor/etnia; sexo, idade, cargo, posição?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 8,
      question: "8. Posso denunciar comportamentos ou práticas antiéticas sem medo de ser punido; através do canal de ética e conduta?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 9,
      question: "9. No meu setor, tenho um ambiente de cooperação e trabalho em equipe?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 11,
      question: "11. A empresa incentiva o equilíbrio entre vida pessoal e profissional?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 12,
      question: "12. Entendo claramente como o meu trabalho contribui para o alcance dos resultados da Masterboi?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 13,
      question: "13. Novas ideias; perspectivas e estilos de trabalho, para a melhoria dos processos são aceitas?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 14,
      question: "14. Recebo treinamento adequado para realização do meu trabalho?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 15,
      question: "15. Eu recebo equipamentos, ferramentas de trabalho e EPI's, necessários para realizar minhas atividades?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 16,
      question: "16. Os processos e procedimentos na Masterboi são claros e bem definidos?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 19,
      question: "19. Sou encorajado pelo meu gestor a pensar em novas maneiras de tornar o trabalho mais produtivo?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 20,
      question: "20. Meu gestor deixa claro; para mim e para a equipe, as metas, objetivos e estratégias do setor?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 21,
      question: "21. Meu gestor imediato reconhece quando eu realizo um bom trabalho?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 22,
      question: "22. Meu gestor realiza comigo o papo de carreira, deixando claro minhas fortalezas e oportunidades, com plano de desenvolvimento?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 24,
      question: "24. A empresa se comunica de maneira eficaz com os colaboradores?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 25,
      question: "25. A liderança me mantém informado(a) sobre as mudanças nos processos e procedimentos da Masterboi?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 26,
      question: "26. Tenho acesso fácil às informações da minha remuneração, banco de horas e/ou premiações?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 27,
      question: "27. Sinto que sou remunerado de forma justa pelo trabalho que realizo?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 28,
      question: "28. Eu conheço os critérios do programa de incentivo à produtividade/premiação da Masterboi?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 30,
      question: "30. Os benefícios oferecidos pela Masterboi são atrativos quando comparados às práticas de outras empresas?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
    ...
    {
      number: 31,
      question: "31. Os benefícios oferecidos pela Masterboi atendem minhas necessidades?",
      type: "emoji_choice",
      options: [
        { label: "SIM", emoji: RostoFeliz, color: "green" },
        { label: "PARCIAL", emoji: RostoNeutro, color: "yellow" }, // <-- ALTERADO
...
function showScreen(screenName) {
  ['welcomeScreen', 'surveyContainer', 'successScreen', 'errorScreen'].forEach(screen => {
...
// User info modal
function openUserInfoModal() { elements.userInfoModal.classList.add('active'); }
function closeUserInfoModal() { elements.userInfoModal.classList.remove('active'); }
...
async function handleUserInfoSubmit(e) {
  ...
  try {
    ...
    if (response.status === 200) {
      ...
      elements.userInfoError.textContent = response.data?.message || 'Erro ao confirmar os dados.';
      elements.userInfoError.style.display = 'block';
    }
  } catch (error) {
    console.error(error);
    elements.userInfoError.textContent = error.response?.data?.error || 'Erro ao buscar colaborador.';
    elements.userInfoError.style.display = 'block';
  } finally {
...
function renderStep() {
  ...
  switch (step.type) {
    case 'emoji_choice': renderEmojiChoice(step); break;
    case 'radio': renderRadioOptions(step); break;
    case 'duration': renderDurationFields(step); break;
    case 'textarea': renderTextarea(step); break;
  }
...
function renderEmojiChoice(step) {
  ...
  step.options.forEach(option => {
    ...
    let emojiContent = '';
    if (typeof option.emoji === 'string' && (option.emoji.endsWith('.png') || option.emoji.endsWith('.jpg') || option.emoji.endsWith('.svg'))) {
    ...
    optionDiv.addEventListener('click', () => selectEmojiOption(container, optionDiv, option.label));
...
function selectEmojiOption(container, selectedOption, value) {
  container.querySelectorAll('.emoji-option').forEach(opt => opt.classList.remove('selected'));
...
function renderRadioOptions(step) {
  step.options.forEach(option => {
    ...
    optionDiv.addEventListener('click', () => selectRadioOption(optionDiv, option));
    elements.questionOptions.appendChild(optionDiv);
  });
}

function selectRadioOption(selectedOption, value) {
  elements.questionOptions.querySelectorAll('.radio-option').forEach(opt => opt.classList.remove('selected'));
  selectedOption.classList.add('selected');
  saveAnswer(value);
  enableContinueButton();
}
...
function renderTextarea(step) {
  ...
  textarea.addEventListener('input', () => { saveAnswer(textarea.value); enableContinueButton(); });
  container.appendChild(textarea);
  elements.questionOptions.appendChild(container);
}

// Save / restore answers
function saveAnswer(value) { appState.answers[`step${appState.currentStep}`] = value; }

function restorePreviousAnswer() {
  const savedAnswer = appState.answers[`step${appState.currentStep}`];
  if (!savedAnswer) { disableContinueButton(); return; }
  const step = surveyData.steps[appState.currentStep - 1];
  switch (step.type) {
    case 'emoji_choice':
    case 'radio':
      const option = elements.questionOptions.querySelector(`[data-value="${savedAnswer}"]`);
      if (option) option.classList.add('selected');
      enableContinueButton();
      break;
    case 'duration':
      const selects = elements.questionOptions.querySelectorAll('select');
      selects.forEach(s => { if (savedAnswer[s.name]) s.value = savedAnswer[s.name]; });
      enableContinueButton();
      break;
    case 'textarea':
...
// Buttons
function enableContinueButton() { elements.continueBtn.disabled = false; }
function disableContinueButton() { elements.continueBtn.disabled = true; }

function updateNavigationButtons() {
  elements.backBtn.style.visibility = appState.currentStep === 1 ? 'hidden' : 'visible';
...
function goToNextStep() {
  ...
  switch (step.type) {
    case 'emoji_choice':
      const selectedEmoji = elements.questionOptions.querySelector('.emoji-option.selected');
      if (selectedEmoji) currentAnswer = selectedEmoji.dataset.value;
      break;
    case 'radio':
      const selectedRadio = elements.questionOptions.querySelector('.radio-option.selected');
...
async function submitSurvey() {
  elements.loadingOverlay.classList.add('active');
  const submissionData = { ...appState.userInfo, answers: appState.answers, timestamp: new Date().toISOString() };
  try {
    const response = await axios.post(
